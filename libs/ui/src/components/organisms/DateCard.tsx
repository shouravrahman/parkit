import { differenceInTime, getTimeUnits } from '@parkit/util/date'
  ...
  return (
    <div className="flex items-center justify-between gap-2 p-2">
      ...
      <div className="flex flex-col items-center">
        <IconArrowRightRhombus className="text-primary" />
        <div className="text-xs text-gray-500">{numOfHours}</div>
      </div>
