...
const variantColor = {
  contained: {
    primary:
      'text-black font-semibold bg-gradient-to-r from-primary-400 to-primary border-0 shadow-lg shadow-primary/20 enabled:hover:from-primary-300 enabled:hover:to-primary-400 enabled:hover:shadow-xl enabled:hover:shadow-primary/40',
